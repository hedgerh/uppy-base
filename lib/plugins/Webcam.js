...
var _utilsDataURItoFile = require('../utils/dataURItoFile');

var _utilsDataURItoFile2 = _interopRequireDefault(_utilsDataURItoFile);
...
var Webcam = (function () {
  ...
  _createClass(Webcam, [{
    ...
    value: function getImage(video, opts) {
      ...
      var file = (0, _utilsDataURItoFile2['default'])(dataUrl, {
        name: opts.name
      });
